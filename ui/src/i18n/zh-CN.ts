...
const zhCN: Record<string, string> = {
  ...
  "admin.tools.btn.importChrome": "导入 Chrome 书签",
  "admin.tools.btn.export": "导出",
  "admin.tools.btn.exportChrome": "导出 Chrome 书签",
  ...
  "admin.tools.form.descMaxLength": "描述最多 {max} 个字符",
  ...
  "admin.tools.msg.exportSuccess": "Chrome 书签导出成功！",
  "admin.tools.msg.importEmpty": "导入数据为空",
  "admin.tools.msg.importing": "正在导入 {count} 条 Chrome 书签...",
  "admin.tools.msg.importComplete": "导入完成：成功 {imported} 条",
  "admin.tools.msg.importSkipped": "，跳过 {skipped} 条",
  "admin.tools.msg.importRefreshing": "，正在刷新图标缓存...",
  "admin.tools.msg.importFailed": "导入失败!",
  "admin.tools.msg.chromeImportInvalid": "请上传 Chrome 导出的书签 HTML 文件",
  ...
  "admin.catelog.form.slug": "URL",
  "admin.catelog.form.slugPlaceholder": "留空自动生成拼音，可填写英文、数字和短横线",
  ...
  "admin.catelog.tagSlug.title": "标签 URL 管理",
  "admin.catelog.tagSlug.name": "标签",
  "admin.catelog.tagSlug.slug": "URL",
  "admin.catelog.tagSlug.save": "保存",
  ...
  "admin.settings.importPreview.tagSlugs": "标签 URL",
  ...
  "admin.settings.msg.importDetailTagSlug": "标签 URL：导入 {count} 条",
