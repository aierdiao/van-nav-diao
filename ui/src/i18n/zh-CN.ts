...
const zhCN: Record<string, string> = {
  ...
  // ==================== Admin SEO 管理页 ====================
  "admin.seo.title": "SEO 管理",
  "admin.seo.tab.category": "分类页",
  "admin.seo.tab.tag": "标签页",
  "admin.seo.selectHint": "← 从左侧选择一个页面来编辑 SEO 信息",
  "admin.seo.typeCategory": "分类页",
  "admin.seo.typeTag": "标签页",
  "admin.seo.tagSuffix": "标签",
  "admin.seo.customized": "已自定义",
  "admin.seo.autoGen": "自动生成",
  "admin.seo.empty": "暂无数据",
  "admin.seo.homePage": "首页",
  "admin.seo.homeAutoDesc": "自动根据站点名称和工具数量生成",
  "admin.seo.homeTitleTooltip": "留空则使用站点标题，自定义后覆盖浏览器标签和搜索结果首页标题",
  "admin.seo.homeTitlePlaceholder": "留空则使用站点标题，例：刁页 | AI 工具导航",
  "admin.seo.homeDescPlaceholder": "留空则自动生成首页描述，建议 80-160 字",
  "admin.seo.previewTitle": "页面标题（自动）",
  "admin.seo.previewDesc": "描述预览（自动生成，填写下方可覆盖）",
  "admin.seo.metaTitle": "自定义标题",
  "admin.seo.metaTitleTooltip": "留空则自动生成「分类名 - 站点名」，自定义后会覆盖浏览器标签和搜索结果标题",
  "admin.seo.metaTitlePlaceholder": "留空则自动生成，例：AI 工具合集 - 刁页",
  "admin.seo.metaDescription": "自定义描述",
  "admin.seo.metaDescriptionTooltip": "留空则使用自动生成的描述，搜索引擎会将其显示在搜索结果摘要中",
  "admin.seo.metaDescriptionPlaceholder": "留空则自动生成，建议 80-160 字",
  "admin.seo.metaKeywords": "关键词",
  "admin.seo.metaKeywordsTooltip": "多个关键词用英文逗号分隔",
  "admin.seo.metaKeywordsPlaceholder": "例：AI工具, 导航站",
  "admin.seo.ogImage": "OG 分享图片",
  "admin.seo.ogImageTooltip": "分享到社交平台时展示的预览图（og:image），建议尺寸 1200x630，留空则使用全局设置",
  "admin.seo.ogImagePlaceholder": "留空则继承全局 SEO 设置，例：https://example.com/og.png",
  "admin.seo.save": "保存",
  "admin.seo.saveHint": "保存后即刻生效",
  "admin.seo.saveSuccess": "SEO 信息已保存",
  "admin.seo.saveFailed": "保存失败",

  // ---- SEO 设置 ----
  "admin.settings.seo.title": "SEO 设置",
  "admin.settings.seo.metaDescription": "页面描述",
  "admin.settings.seo.metaDescriptionTooltip": "自定义首页的 meta description，留空则自动生成。搜索引擎会将其显示在搜索结果中",
  "admin.settings.seo.metaDescriptionPlaceholder": "请输入首页描述，留空则自动生成",
  "admin.settings.seo.metaKeywords": "关键词",
  "admin.settings.seo.metaKeywordsTooltip": "自定义首页的 meta keywords，多个关键词用英文逗号分隔",
  "admin.settings.seo.metaKeywordsPlaceholder": "例：AI工具, 导航站, 跨境电商",
  "admin.settings.seo.ogImage": "OG 分享图片",
  "admin.settings.seo.ogImageTooltip": "分享到社交平台时展示的预览图片 URL（og:image），建议尺寸 1200x630",
  "admin.settings.seo.ogImagePlaceholder": "请输入图片 URL，例：https://example.com/og.png",
